...
import in.genrateBill.BillingSoftware.entity.UserEntity;
import in.genrateBill.BillingSoftware.io.UserRequest;
import in.genrateBill.BillingSoftware.io.UserResponse;
import in.genrateBill.BillingSoftware.repository.UserRepository;
...
public class UserServiceImpl implements UserService {
    ...
    public String getUserRole(String email) {
       UserEntity existingUser = userRepository.findByEmail(email)
                .orElseThrow(() -> new UsernameNotFoundException("user is not found on this email: "+email) );
